...
export const PIPELINE_ID = 'ai-fitness-planner-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 \u00b7 Collect profile & days",
  process: "Step 2/3 \u00b7 Build workout blocks",
  output: "Step 3/3 \u00b7 Adjustable plan + notes",
}
