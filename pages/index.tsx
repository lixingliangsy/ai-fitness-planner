  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://ai-fitness-planner.lxsaihub.com/" />
        <script type="application/ld+json">{`{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Workout blocks vs full periodization?", "acceptedAnswer": {"@type": "Answer", "text": "The tool drafts adjustable blocks (sets/structure) for your stated days and level. Advanced periodization still needs a coach or clinician for special populations."}}, {"@type": "Question", "name": "Where do diet suggestions fit?", "acceptedAnswer": {"@type": "Answer", "text": "Optional, high-level suggestions only. Nutrition needs vary; this is not a registered dietitian consult or medical nutrition therapy."}}, {"@type": "Question", "name": "What ACSM themes apply?", "acceptedAnswer": {"@type": "Answer", "text": "Individualize by habitual activity, function, health status, and goals (ACSM Position Stand PMID 21694556). Resistance frequency and recovery still apply."}}, {"@type": "Question", "name": "How is this different from AI Fitness Plan Generator?", "acceptedAnswer": {"@type": "Answer", "text": "Planner emphasizes workout blocks + diet suggestions. Generator emphasizes goal-based programming and weekly schedule export."}}, {"@type": "Question", "name": "Is it safe for beginners?", "acceptedAnswer": {"@type": "Answer", "text": "Beginner options exist, but start conservatively and stop if pain (not normal training discomfort) appears. Seek care when unsure."}}, {"@type": "Question", "name": "Any medical claims?", "acceptedAnswer": {"@type": "Answer", "text": "No. Decision-support only — not a device, diagnosis, or treatment plan."}}]}`}</script>
      </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">AI Fitness Planner - definition</h2>
