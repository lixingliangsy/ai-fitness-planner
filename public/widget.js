 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="ai-fitness-planner" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "ai-fitness-planner";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "ai-fitness-planner") + "_chat_session";
